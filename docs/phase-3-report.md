...
| GitHub Actions | PASS | PR run `29467358773` / push run `29467357336`、head `36400b4` |
...
実装・ローカル検証・Windows手動QA・GitHub ActionsのPhase 3ジョブ（Python / Godot 4.7.1）は完了しています。PR run `29467358773` とpush run `29467357336` は、いずれもhead `36400b4` で成功しました。公開ブランチはDraft PR #1でレビュー可能な状態です。
